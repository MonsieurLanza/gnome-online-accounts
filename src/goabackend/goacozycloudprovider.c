...
struct _GoaCozycloudProvider
{
  GoaProvider parent_instance;
};

typedef struct _GoaCozycloudProviderClass GoaCozycloudProviderClass;

struct _GoaCozycloudProviderClass
{
  GoaProviderClass parent_class;
};

G_DEFINE_TYPE_WITH_CODE (GoaCozycloudProvider, goa_cozycloud_provider, GOA_TYPE_PROVIDER,
...
static const gchar *CALDAV_ENDPOINT = "public/sync/";
static const gchar *CARDDAV_ENDPOINT = "public/sync/";
static const gchar *WEBDAV_ENDPOINT = "";

static const gchar *
get_provider_type (GoaProvider *provider)
{
  return GOA_COZYCLOUD_NAME;
}

static gchar *
get_provider_name (GoaProvider *provider, GoaObject *object)
{
  return g_strdup(_("CozyCloud"));
}
              ...
              GError             **error)
{
  ...
  /* Chain up */
  if (!GOA_PROVIDER_CLASS (goa_cozycloud_provider_parent_class)->build_object (provider,
                                                                              object,
                                                                              key_file,
                                                                              group,
                                                                              connection,
  ...
  if (g_cancellable_is_cancelled (data.cancellable))
  ...
  else if (data.error != NULL)
    {
      ...
      markup = g_strdup_printf ("<b>%s:</b>\n%s",
                                _("Error connecting to Cozy Cloud server"),
                                data.error->message);
                 ...
                 GError        **error)
{
  ...
  g_return_val_if_fail (GOA_IS_COZYCLOUD_PROVIDER (provider), FALSE);
...
static void
goa_cozycloud_provider_init (GoaCozycloudProvider *self)
{
}

static void
goa_cozycloud_provider_class_init (GoaCozycloudProviderClass *klass)
{
